				...
				//System.out.println("For Employee "+e.getEmployeeName()+ "Sub Projects are ");
				 ...
				 for(@SuppressWarnings("rawtypes") Map.Entry<String,Double> m:datesOn.entrySet()){  
					 ...
					 if( m.getValue() == 8){
						 ...
						 System.out.println("Warning : "+ e.getEmployeeName() +" has issue in hours on "+m.getKey()+" Total hours for the day is : "+m.getValue()+" is less than 8 Hours");
					 }else{
						 System.out.println("Ërror : "+ e.getEmployeeName() +" has issue in hours on "+m.getKey()+" Total hours for the day is : "+m.getValue()+" greater than 8 hours");
					 }
		        	  }
